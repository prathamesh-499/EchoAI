        ...
        <div className="bg-dark vh-100 d-flex justify-content-center align-items-center">
            ...
            <div className="bg-black text-white p-5 rounded shadow" style={{ width: "400px" }}>
                ...
                <form onSubmit={handleSubmit}>
                    <div className="mb-4"><input className="form-control text-center" type="text" inputMode="numeric" autoComplete="one-time-code" maxLength="6" placeholder="000000" value={otp} onChange={(event) => setOtp(event.target.value.replace(/\D/g, ""))} autoFocus /></div>
